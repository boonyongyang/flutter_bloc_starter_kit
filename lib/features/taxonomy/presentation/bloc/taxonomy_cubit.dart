...
import '../../data/repositories/i_taxonomy_repository.dart';
import 'taxonomy_state.dart';

class TaxonomyCubit extends Cubit<TaxonomyState> {
  final ITaxonomyRepository _taxonomyRepository;
    ...
    try {
      ...
      if (fact != null) {
        emit(TaxonomyLoaded(
          ...
          taxonomyType: TaxonomyConstants.familyType,
        ));
      } else {
        emit(TaxonomyError(
    ...
    try {
      ...
      if (fact != null) {
        emit(TaxonomyLoaded(
          ...
          taxonomyType: TaxonomyConstants.genusType,
        ));
      } else {
    ...
    try {
      ...
      if (fact != null) {
        emit(TaxonomyLoaded(
          ...
          taxonomyType: TaxonomyConstants.orderType,
        ));
      } else {
